...
@section('content')
    ...
    {{--    {{ dd($articleTrue) }}--}}
    <form method="post" action="{{ url('articles/updateFalse/' . $category->id) }}" enctype="multipart/form-data"
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="created_at" value="{{ $category->created_at }}"
                       required/>
            </div>
